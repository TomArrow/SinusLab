...
namespace SinusLab
{
    ...
    static class Helpers
    {
        ...
        public static Bitmap ByteArrayToBitmap(LinearAccessByteImageUnsigned byteImage)
        {
        ...
        public static LinearAccessByteImageUnsigned BitmapToLinearAccessByteArray(Bitmap bmp)
        {
            ...
            return new LinearAccessByteImageUnsigned(rgbValues, stride, bmp.Width, bmp.Height, bmp.PixelFormat);
        }
